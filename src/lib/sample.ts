...
export const gridDays = [
  { key: '2029-08-20', dow: 'Mon', date: 'Aug 20', best: false },
  { key: '2029-08-21', dow: 'Tue', date: 'Aug 21', best: false },
  { key: '2029-08-22', dow: 'Wed', date: 'Aug 22', best: true },
  { key: '2029-08-23', dow: 'Thu', date: 'Aug 23', best: false },
  { key: '2029-08-24', dow: 'Fri', date: 'Aug 24', best: false },
] as const

// avail[dayKey][timeIndex] = ids of everyone free in that slot
export const avail: Record<string, string[][]> = {
  '2029-08-20': [['JM', 'SR', 'KL'], ['JM', 'AT'], [], ['SR', 'PR', 'CL'], ['JM', 'SR', 'AT', 'KL']],
  '2029-08-21': [['JM', 'SR', 'AT', 'KL', 'PR'], ['JM', 'SR', 'KL'], ['AT', 'PR'], [], ['SR', 'KL', 'MN', 'CL']],
  '2029-08-22': [
  ...
  '2029-08-23': [['JM', 'AT'], ['JM', 'AT', 'KL', 'PR'], [], ['AT', 'MN'], ['SR', 'KL']],
  '2029-08-24': [[], [], [], ['KL'], []],
}
...
export const messages: ChatMessage[] = [
  { id: 'SR', name: 'Sarah R', time: '2h ago', text: 'Can we avoid Thu Aug 23? Travel might be tricky that week', you: false },
  { id: 'KL', name: 'Kyle L', time: '1h ago', text: '+1. Wed Aug 22 looks strongest on the grid', you: false },
  { id: 'JM', name: 'You', time: '45m ago', text: "Good call, lock Aug 22? Budget's at $4.2k", you: true },
