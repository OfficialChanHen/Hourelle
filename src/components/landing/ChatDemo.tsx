...
export function ChatDemo() {
  ...
  return (
    <div ref={ref}>
      <VignetteFrame url="aline.app/e/rooftop-dinner" hint={!done ? 'Watch first. It is yours in a moment.' : 'Say whether you are coming, then say it in the room.'} taken={taken} onReset={reset}>
